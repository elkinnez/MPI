...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PB0     ------> ADC1_IN8
    */
    GPIO_InitStruct.Pin = LINEA_FR_Pin|LINEA_RL_Pin|LINEA_RR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LINEA_FL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(LINEA_FL_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOA, LINEA_FR_Pin|LINEA_RL_Pin|LINEA_RR_Pin);

    HAL_GPIO_DeInit(LINEA_FL_GPIO_Port, LINEA_FL_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM3)
  {
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(ECHO_US_GPIO_Port, ECHO_US_Pin);
